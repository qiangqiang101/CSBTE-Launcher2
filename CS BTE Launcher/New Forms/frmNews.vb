...
#End Region
    ...
    Private Sub frmNews_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        'Me.Left = frmBackground2.Right - 550
        'Me.Top = frmBackground2.Top + 50

        WebBrowser1.Navigate("http://csbte.tk/bte/news2.php")
    End Sub
    ...
    Private Sub WebBrowser1_DocumentCompleted(ByVal sender As Object, ByVal e As System.Windows.Forms.WebBrowserDocumentCompletedEventArgs)
        WebBrowser1.Document.BackColor = Color.FromArgb(32, 32, 32)
        WebBrowser1.Document.ForeColor = Color.White
        WebBrowser1.Document.ActiveLinkColor = Color.White
        WebBrowser1.Document.VisitedLinkColor = Color.White
        WebBrowser1.Document.LinkColor = Color.White
    End Sub
