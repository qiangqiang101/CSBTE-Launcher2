...
#End Region
    ...
    Private Sub SteamButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SteamButton1.Click
        frmParent.ShowHideTaskBar()
        frmParent.ShowStartButton()
