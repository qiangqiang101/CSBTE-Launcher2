...
2:
    ...
    Private Sub lv_Player_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lv_Player.SelectedIndexChanged
        ...
        Else
            lbl_Sex.Text = "Female"
        End If
        If lv_Player.SelectedItems(0).SubItems(6).Text = "cso" Then
            lbl_Tattoo.Text = "No Tattoo"
        ElseIf lv_Player.SelectedItems(0).SubItems(6).Text = "dragon" Then
            lbl_Tattoo.Text = "Dragon"
        ElseIf lv_Player.SelectedItems(0).SubItems(6).Text = "ma_blue" Then
            lbl_Tattoo.Text = "Metal Arena Blue Team"
        ElseIf lv_Player.SelectedItems(0).SubItems(6).Text = "ma_red" Then
            lbl_Tattoo.Text = "Metal Arena Red Team"
        ElseIf lv_Player.SelectedItems(0).SubItems(6).Text = "tiger" Then
            lbl_Tattoo.Text = "Tiger"
        ElseIf lv_Player.SelectedItems(0).SubItems(6).Text = "ttbambou" Then
            lbl_Tattoo.Text = "Shochiku"
        ElseIf lv_Player.SelectedItems(0).SubItems(6).Text = "ttchaos" Then
            lbl_Tattoo.Text = "Flame"
        ElseIf lv_Player.SelectedItems(0).SubItems(6).Text = "ttcustom" Then
            lbl_Tattoo.Text = "Chi"
        ElseIf lv_Player.SelectedItems(0).SubItems(6).Text = "ttletter1" Then
            lbl_Tattoo.Text = "God of Jiong arrive"
        ElseIf lv_Player.SelectedItems(0).SubItems(6).Text = "ttletter2" Then
            lbl_Tattoo.Text = "One Man Hold All Enemy"
        ElseIf lv_Player.SelectedItems(0).SubItems(6).Text = "ttletter3" Then
            lbl_Tattoo.Text = "Eliminate War with War"
        ElseIf lv_Player.SelectedItems(0).SubItems(6).Text = "ttpoisonfire" Then
            lbl_Tattoo.Text = "Poison Fire"
        ElseIf lv_Player.SelectedItems(0).SubItems(6).Text = "ttsnow" Then
            lbl_Tattoo.Text = "Snow Crystal"
        Else
            lbl_Tattoo.Text = "Unknown"
        End If
    End Sub
...
2:
    ...
    Private Sub lv_MyPlayer_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lv_MyPlayer.SelectedIndexChanged
        ...
        Else
            lbl_Sex.Text = "Female"
        End If
        If lv_MyPlayer.SelectedItems(0).SubItems(6).Text = "cso" Then
            lbl_Tattoo.Text = "No Tattoo"
        ElseIf lv_MyPlayer.SelectedItems(0).SubItems(6).Text = "dragon" Then
            lbl_Tattoo.Text = "Dragon"
        ElseIf lv_MyPlayer.SelectedItems(0).SubItems(6).Text = "ma_blue" Then
            lbl_Tattoo.Text = "Metal Arena Blue Team"
        ElseIf lv_MyPlayer.SelectedItems(0).SubItems(6).Text = "ma_red" Then
            lbl_Tattoo.Text = "Metal Arena Red Team"
        ElseIf lv_MyPlayer.SelectedItems(0).SubItems(6).Text = "tiger" Then
            lbl_Tattoo.Text = "Tiger"
        ElseIf lv_MyPlayer.SelectedItems(0).SubItems(6).Text = "ttbambou" Then
            lbl_Tattoo.Text = "Shochiku"
        ElseIf lv_MyPlayer.SelectedItems(0).SubItems(6).Text = "ttchaos" Then
            lbl_Tattoo.Text = "Flame"
        ElseIf lv_MyPlayer.SelectedItems(0).SubItems(6).Text = "ttcustom" Then
            lbl_Tattoo.Text = "Chi"
        ElseIf lv_MyPlayer.SelectedItems(0).SubItems(6).Text = "ttletter1" Then
            lbl_Tattoo.Text = "God of Jiong arrive"
        ElseIf lv_MyPlayer.SelectedItems(0).SubItems(6).Text = "ttletter2" Then
            lbl_Tattoo.Text = "One Man Hold All Enemy"
        ElseIf lv_MyPlayer.SelectedItems(0).SubItems(6).Text = "ttletter3" Then
            lbl_Tattoo.Text = "Eliminate War with War"
        ElseIf lv_MyPlayer.SelectedItems(0).SubItems(6).Text = "ttpoisonfire" Then
            lbl_Tattoo.Text = "Poison Fire"
        ElseIf lv_MyPlayer.SelectedItems(0).SubItems(6).Text = "ttsnow" Then
            lbl_Tattoo.Text = "Snow Crystal"
        Else
            lbl_Tattoo.Text = "Unknown"
        End If
